...
for _, line in enumerate(links_file):
    ...
    for i_id in tmp[1:]: 
        ...
        if flag==0:
            ...
            flag=0
    # num_u_i_t+=len(tmp)-1
print(num_u_i_t,num_u_i_v)
# pdb.set_trace()
np.save('./datanpy/testing_set.npy',[test_data_user,test_data_item,num_u_i_t])  
np.save('./datanpy/val_set.npy',[val_data_user,val_data_item,num_u_i_v]) 
